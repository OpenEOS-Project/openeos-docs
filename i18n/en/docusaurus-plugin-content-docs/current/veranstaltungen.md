...
An **event** is the container for a specific festival or sales day. Products, prices, locations, orders, and reports always relate to an event. Before you create products or accept orders, you therefore need to create an event and **activate** it first.
...
2. Fill in the form:
   ...
   - **Online-Shop aktivieren** — allows guests to order items from this event online
3. Click **Create**.
...
The active event controls which products appear at the till and which event orders are assigned to. When you switch the active event, the context in products, locations, and stock management switches with it.
:::
