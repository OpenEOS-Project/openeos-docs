...
description: Bestellung aufnehmen, kassieren und an Küche oder Theke weitergeben.
---
...
1. **Kategorie wählen** — links antippen.
2. **Produkte hinzufügen** — auf das **+** der Karte tippen. Jeder weitere Tipp erhöht die Menge.
3. **Menge ändern** — im Warenkorb rechts mit **−** und **+**. Auf Null gesetzt, verschwindet die Zeile.
4. **Kassieren** — unten auf **Bar** oder **Karte** tippen.

Die Bestellung ist damit abgeschlossen. Was an Küche oder Theke gehen muss, wird sofort dorthin weitergeleitet — siehe [Anzeigen](./anzeigen.md) und [Drucker](./drucker.md).
...
**Warenkorb leeren** unter dem Bezahlen-Knopf verwirft die angefangene Bestellung. Es wird nichts gespeichert und nichts weitergeleitet.
